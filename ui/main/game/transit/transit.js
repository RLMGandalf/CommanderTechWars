...
$(document).ready(function () {
    ...
    if (!model.transitDestination()) {
        ...
        model.transitPrimaryMessage(loc('!LOC(transit:error.message):Error'));
        model.transitSecondaryMessage(loc('!LOC(transit:returning_to_main_menu.message):Returning to Main Menu'));
    }
