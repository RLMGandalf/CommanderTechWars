...
define(['shared/gw_common'], function (GW) {
    return {
        ...
        describe: function(params) { 
            return '!LOC(galactic_war:vehicle_fabrication_tech_reduces_metal_build_costs_of_all_vehicles_by_25.message):Vehicle Fabrication Tech reduces metal build costs of all vehicles by 25%';
        },
        summarize: function(params) {
            return '!LOC(galactic_war:vehicle_fabrication_tech.message):Vehicle Fabrication Tech';
        },
