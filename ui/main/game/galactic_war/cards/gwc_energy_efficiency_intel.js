...
define(['shared/gw_common'], function (GW) {
    return {
        ...
        describe: function(params) { 
            return "!LOC(galactic_war:improved_intelligence_tech_reduces_energy_costs_for_intelligence_structres_by_75.message):Improved Intelligence Tech reduces energy costs for intelligence structres by 75%";
        },
        summarize: function(params) {
            return '!LOC(galactic_war:improved_intelligence_tech.message):Improved Intelligence Tech';
        },
