...
define(['shared/gw_common'], function (GW) {
    return {
        ...
        describe: function(params) { 
            return "!LOC(galactic_war:improved_fabricator_build_arms_increase_the_build_speed_of_all_fabricator_and_factory_build_arms_by_50_and_reduces_energy_usage_by_50.message):Improved Fabricator Build Arms increase the build speed of all fabricator and factory build arms by 50% and reduces energy usage by 50%.";
        },
        summarize: function(params) {
            return '!LOC(galactic_war:improved_fabricator_build_arms.message):Improved Fabricator Build Arms';
        },
