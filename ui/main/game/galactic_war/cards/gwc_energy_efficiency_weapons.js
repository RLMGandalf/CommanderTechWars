...
define(['shared/gw_common'], function (GW) {
    return {
        ...
        describe: function(params) { 
            return "!LOC(galactic_war:improved_energy_weapons_tech_reduces_energy_costs_for_energy_based_weapons_by_75.message):Improved Energy Weapons tech reduces energy costs for energy based weapons by 75%";
        },
        summarize: function(params) {
            return '!LOC(galactic_war:improved_energy_weapons.message):Improved Energy Weapons';
        },
