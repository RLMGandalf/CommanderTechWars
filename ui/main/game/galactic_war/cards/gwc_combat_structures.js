...
define(['shared/gw_common'], function (GW) {
    return {
        ...
        describe: function(params) { 
            return '!LOC(galactic_war:structure_combat_tech_increases_the_health_of_all_structures_by_50_defensive_structures_also_gain_a_25_damage_increase.message):Structure Combat Tech increases the health of all structures by 50%. Defensive structures also gain a 25% damage increase.';
        },
        summarize: function(params) {
            return '!LOC(galactic_war:structure_combat_tech.message):Structure Combat Tech';
        },
