...
define(['shared/gw_common'], function (GW) {
    return {
        ...
        describe: function(params) { 
            return '!LOC(galactic_war:defense_fabrication_tech_reduces_metal_build_costs_of_all_defensive_structures_by_50.message):Defense Fabrication Tech reduces metal build costs of all defensive structures by 50%';
        },
        summarize: function(params) {
            return '!LOC(galactic_war:defense_fabrication_tech.message):Defense Fabrication Tech';
        },
