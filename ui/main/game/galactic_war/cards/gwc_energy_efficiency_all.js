...
define(['shared/gw_common'], function (GW) {
    return {
        ...
        describe: function(params) { 
            return "!LOC(galactic_war:complete_energy_tech_reduces_energy_costs_for_intelligence_structres_by_75_weapon_energy_costs_by_75.message):Complete Energy Tech reduces energy costs for intelligence structres by 75%, weapon energy costs by 75%.";
        },
        summarize: function(params) {
            return '!LOC(galactic_war:complete_energy_tech.message):Complete Energy Tech';
        },
