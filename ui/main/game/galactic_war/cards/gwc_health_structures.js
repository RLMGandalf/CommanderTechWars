...
define(['shared/gw_common'], function (GW) {
    return {
        ...
        describe: function(params) { 
            return '!LOC(galactic_war:structure_armor_tech_increases_the_health_of_all_structures_by_50.message):Structure Armor Tech increases the health of all structures by 50%';
        },
        summarize: function(params) {
            return '!LOC(galactic_war:structure_armor_tech.message):Structure Armor Tech';
        },
