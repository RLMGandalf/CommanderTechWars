...
define(['shared/gw_common'], function (GW) {
    return {
        ...
        describe: function(params) { 
            return '!LOC(galactic_war:bot_ammunition_tech_increases_damage_of_all_bots_by_25.message):Bot Ammunition Tech increases damage of all bots by 25%';
        },
        summarize: function(params) {
            return '!LOC(galactic_war:bot_ammunition_tech.message):Bot Ammunition Tech';
        },
