...
define(['shared/gw_common'], function (GW) {
    return {
        ...
        describe: function (params) {
            return '!LOC(galactic_war:complete_naval_tech_enables_building_of_all_naval_units_and_all_naval_factories_basic_naval_factories_are_built_via_your_commander_or_any_basic_fabricator_advanced_naval_factories_are_built_via_basic_or_advanced_naval_fabricators.message):Complete Naval Tech enables building of all naval units and all naval factories. Basic naval factories are built via your commander or any basic fabricator. Advanced naval factories are built via basic or advanced naval fabricators.';
        },
        summarize: function (params) {
            return '!LOC(galactic_war:complete_naval_tech.message):Complete Naval Tech';
        },
