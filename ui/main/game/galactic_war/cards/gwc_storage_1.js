...
define(['shared/gw_common'], function (GW) {
    return {
        ...
        describe: function(params) { 
            return '!LOC(galactic_war:metal_and_energy_storage_on_all_commanders_and_storage_structures_increased_by_300_adds_in_blueprints_for_storage_structures.message):Metal and energy storage on all commanders and storage structures increased by 300%. Adds in blueprints for storage structures.';
        },
        summarize: function(params) {
            return '!LOC(galactic_war:storage_compression_tech.message):Storage Compression Tech';
        },
