...
define(['shared/gw_common'], function (GW) {
    return {
        ...
        describe: function (params) {
            return '!LOC(galactic_war:advanced_naval_tech_enables_building_of_the_advanced_naval_factory_and_advanced_naval_units_advanced_naval_factories_are_built_via_your_advanced_naval_fabricators.message):Advanced Naval Tech enables building of the Advanced Naval Factory and advanced naval units. Advanced Naval Factories are built via your Advanced Naval Fabricators.';
        },
        summarize: function (params) {
            return '!LOC(galactic_war:advanced_naval_tech.message):Advanced Naval Tech';
        },
