...
define(['shared/gw_common'], function (GW) {
    return {
        ...
        describe: function(params) { 
            return '!LOC(galactic_war:advanced_orbital_tech_enables_the_building_of_orbital_fabricators_and_orbital_factories_orbital_fabricators_are_built_via_the_orbital_launcher_and_orbital_factories_build_by_the_orbital_fabricators.message):Advanced Orbital Tech enables the building of orbital fabricators and orbital factories. Orbital fabricators are built via the orbital launcher and orbital factories build by the orbital fabricators.';
        },
        summarize: function(params) {
            return '!LOC(galactic_war:advanced_orbital_tech.message):Advanced Orbital Tech';
        },
