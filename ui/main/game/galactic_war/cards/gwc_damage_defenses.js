...
define(['shared/gw_common'], function (GW) {
    return {
        ...
        describe: function(params) { 
            return '!LOC(galactic_war:defense_ammunition_tech_increases_damage_of_all_defensive_structures_by_25.message):Defense Ammunition Tech increases damage of all defensive structures by 25%';
        },
        summarize: function(params) {
            return '!LOC(galactic_war:defense_ammunition_tech.message):Defense Ammunition Tech';
        },
