...
define(['shared/gw_common'], function (GW) {
    return {
        ...
        describe: function(params) { 
            return '!LOC(galactic_war:orbital_engine_tech_increases_speed_of_all_orbital_units_by_50.message):Orbital Engine Tech increases speed of all orbital units by 50%';
        },
        summarize: function(params) {
            return '!LOC(galactic_war:orbital_engine_tech.message):Orbital Engine Tech';
        },
