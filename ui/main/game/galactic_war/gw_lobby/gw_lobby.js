...
$(document).ready(function () {
    ...
    function GWLobbyViewModel() {
        ...
        self.config = ko.observable('').extend({ session: 'gw_battle_config' });
    ...
    handlers.connection_disconnected = function (payload) {
        ...
        transitPrimaryMessage(loc('!LOC(gw_lobby:connection_to_server_lost.message):CONNECTION TO SERVER LOST'));
