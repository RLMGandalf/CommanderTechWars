                        ...
                        utils.ajax.get( utils.endpoints.userInfo(), function(userInfo){
                            ...
                            for(i=0; i<videos.length; i++){
                                if(videos[i].media$group.yt$duration){
                                    ...
                                    list += '<li'+isFirst+'><a href="#" data-ytv="'+(video.slug)+'" title="'+(video.title)+'" class="ytv-clear">';
                                    list += '<div class="ytv-thumb"><div class="ytv-thumb-stroke"></div><span>'+(time)+'</span><img src="'+(video.thumb)+'"></div>';
                                    list += '<div class="ytv-content">'+(video.title);
                                    if (video.stats)
                                    {
...
//                            settings.element.innerHTML = '<div class="ytv-relative"><div class="ytv-video"><div id="ytv-video-player"></div></div><div class="ytv-list">'+list+'</div></div>';
                            settings.element.innerHTML = '<div class="ytv-relative"><div class="ytv-list">'+list+'</div></div>';
                    ...
                    videoClick: function(e){
                        ...
                        if(target){
                            if(target.getAttribute('data-ytv')) {
                                ...
                                startYoutubeVideoSequence(target.getAttribute('data-ytv'),target.getAttribute('title'));
                            }
                        }
