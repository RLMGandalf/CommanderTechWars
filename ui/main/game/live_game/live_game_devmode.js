...
$(document).ready(function () {
    ...
    function DevModeViewModel() {
        ...
        self.updatePlayerVisionFlag = function (index) {
            ...
            // Tell the client
            var clientFlags = _.map(newFlags, function(flag) { return flag ? 1 : 0; });
            engine.call('game.updateObservableArmySet', clientFlags);
        ...
        self.updatePlayerControlFlag = function (index) {
            ...
            // Tell the client
            engine.call('game.updateControlableArmySet', clientControlFlags);
            engine.call('game.updateObservableArmySet', clientVisionFlags);
