...
var triggerModel = (function () {
    ...
    function TriggerModel() {
        ...
        triggers[constants.event_type.enemy_metal_destroyed] = new TriggerCondition({
            ...
            normalize: false,
            greater: true,
            callback: function () { console.log('emd'); audioModel.triggerBattleMusic() }
        });
